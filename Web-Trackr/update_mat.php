...
if(!isset($_GET['matID']) || empty($_GET['matID']))
...
if(isset($_POST['submit']))
{
    ...
    $update = "UPDATE MATERIAL SET matName = '$new_name' WHERE matID = $matID";
...
$sql = "select * from MATERIAL where matID=$matID";
...
<div id='restricted' class="container">
    ...
    <form id="myform" method='POST'>
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" name="name" value="<?echo  htmlspecialchars($name)?>" placeholder="Enter the full name" required>
        </div>
